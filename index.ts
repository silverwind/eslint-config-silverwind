...
const config: Array<Linter.Config> = [
  ...
  },
  {
    ...
    rules: {
      ...
      "unicorn/no-thenable": [0], // false-positives on json schemas
  ...
  },
  {
    ...
    rules: {
      ...
      "vitest/no-importing-vitest-globals": [0],
  ...
  },
  {
    ...
    rules: {
      ...
      "playwright/no-raw-locators": [0],
      "playwright/no-restricted-locators": [0],
      "playwright/no-restricted-matchers": [0],
      "playwright/no-restricted-roles": [0],
      ...
      "playwright/prefer-locator": [2],
      "playwright/prefer-lowercase-title": [0],
      "playwright/prefer-native-locators": [0],
      "playwright/prefer-strict-equal": [0],
      "playwright/prefer-to-be": [0],
      "playwright/prefer-to-contain": [0],
      ...
      "playwright/require-to-pass-timeout": [0],
      "playwright/require-to-throw-message": [0],
      "playwright/require-top-level-describe": [0],
  ...
  },
  {
    ...
    rules: {
      ...
      "@eslint-react/dom/no-unsafe-iframe-sandbox": [2],
      ...
      "@eslint-react/naming-convention/id-name": [0],
      ...
      "@eslint-react/no-unnecessary-use-ref": [0],
      ...
      "@eslint-react/prefer-use-state-lazy-initialization": [0], // https://github.com/Rel1cx/eslint-react/issues/1606
