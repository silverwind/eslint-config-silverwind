...
["1", "2"].reverse().reduce((p, c) => p + c, ""); // eslint-disable-line unicorn/prefer-array-last-methods
Array.from([]).map((t) => t); // eslint-disable-line unicorn/no-unused-array-method-return, unicorn/prefer-array-from-map
