...
export default defineConfig([
  ...
  },
  {
    ...
    rules: {
      ...
      "@eslint-react/dom/no-dangerously-set-innerhtml-with-children": [0],
      ...
      "@eslint-react/no-default-props": [0],
      ...
      "@eslint-react/no-unnecessary-use-callback": [0],
      "@eslint-react/no-unnecessary-use-memo": [0],
      ...
      "@eslint-react/no-unused-props": [0],
      "@eslint-react/no-unused-state": [2],
      "@eslint-react/no-use-context": [0],
      "@eslint-react/no-useless-forward-ref": [0],
      "@eslint-react/no-useless-fragment": [0], // disabled because its useful with <Tooltip>
